...
import { ContactoActionCreate } from '@/lib/actions';
import { useFormState } from 'react-dom';
import { useState } from 'react';

export default function ContactoCreateForm({ listas }: { listas: TypeLista[] }) {
  const initialState = { message: '', errors: {} };
  const [state, dispatch] = useFormState(ContactoActionCreate, initialState);

  const [avatarurl, setAvatarurl] = useState(process.env.NEXT_PUBLIC_IMAGENOTFOUNT_URL);
