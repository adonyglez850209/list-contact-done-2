...
export default async function ReporteContactosEstadoCuotaGenero({
  elementos,
}: {
  elementos: TypeReporteEstadoCuotaGroupByGenero[];
}) {
  return (
    <div className="w-full">
      ...
      <Search placeholder="Buscar genero..." />
            ...
            <div className="md:hidden">
                    ...
                    <div className="flex items-center justify-between border-b pb-4">
                      <div className="flex w-full items-center justify-between border-b py-5">
                        <div className="flex w-1/2 flex-col">
                          ...
                          <p className="font-medium">{elemento.sexo}</p>
                        </div>
                        <div className="flex w-1/2 flex-col">
              ...
              <table className="hidden min-w-full text-gray-900 md:table">
                ...
                <tbody className="bg-white">
                  {elementos.map((elemento) => (
                    <tr key={elemento.sexo} className="group">
